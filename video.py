...
def playvideo(path):
    ...
    print()
    os.system("python playvideo.py" + " " + path)
...
wallpaper1b = Button(window, text="wallpaper1", image=wallpaper1icon, command=lambda:playvideo(wallpaper1))
wallpaper1b.place(x=25,y=100)

# Create button for wallpaper 2
wallpaper2icon = PhotoImage(file=wallpaper2iconpath)
wallpaper2b = Button(window, text="wallpaper2", image=wallpaper2icon, command=lambda:playvideo(wallpaper2))
wallpaper2b.place(x=150,y=100)

# Create button for wallpaper 3
wallpaper3icon = PhotoImage(file=wallpaper3iconpath)
wallpaper3b = Button(window, text="wallpaper3", image=wallpaper3icon, command=lambda:playvideo(wallpaper3))
...
setbutton = Button(window, text="Set", command=lambda:playvideo(os.path.abspath(pathtocustomwallpaper.get())))
setbutton.place(x=185,y=330)
